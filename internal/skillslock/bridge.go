...
func FromRecord(ls Record) Entry {
	...
	ext := &Ext{
		Scope:          scope,
		BaseHash:       ls.Resolved.BaseHash,
		OverrideDigest: ls.Resolved.OverrideDigest,
		Override:       ls.Resolved.Override,
...
func ToRecord(name string, e Entry) Record {
	...
	return Record{
		...
		Resolved: Resolved{
			...
			BaseHash:       ext.BaseHash,
			OverrideDigest: ext.OverrideDigest,
